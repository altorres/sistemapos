...
class ModelProductos 
{
	...
	static public function mdlIngresarProducto($tabla,$datos){
		...
		$stmt->bindParam(":imagen", $datos["ruta"], PDO::PARAM_STR);
		$stmt->bindParam(":stock", $datos["stock"], PDO::PARAM_STR);
		$stmt->bindParam(":precio_compra", $datos["compra"], PDO::PARAM_STR);
		$stmt->bindParam(":precio_venta", $datos["venta"], PDO::PARAM_STR);
