          ...
          <div class="box-body">
                ...
                <div class="input-group">
                  ...
                  <select name="nuevaCategoria" id="nuevaCategoria" class="form-control input-lg" required>
                    ...
                    <?php
                      ...
                      $categoria=ControllerCategoria::ctrMostrarCategoria($item,$valor,$orden);
            ...
            <!--Input Codigo-->
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" name="nuevoCodigo" id="nuevoCodigo" class="form-control input-lg" placeholder="Ingresar Código" readonly required> 
            ...
            <!--Input descripcion -->
              ...
              <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-md-6">
                    <div class="input-group">
                      ...
                      <input type="number" name="nuevoPrecioCompra" id="nuevoPrecioCompra" class="form-control input-lg" min="0" step="any" placeholder=" Precio de compra" required> 
              ...
              <!--Input compra-->
                <div class="col-xs-12 col-md-6">
                  <div class="input-group ">                  
                    ...
                    <input type="number" name="nuevoPrecioVenta" id="nuevoPrecioVenta"  class="form-control input-lg" min="0" step="any" placeholder=" Precio de venta" required> 
              ...
              <div class="form-group">
                ...
                <img src="View/img/productos/default/anonymous.png" width="100px" class="img-thumbnail previsualizar">
              </div>
