...
$totalVentas = ControllerProductos::ctrMostrarSumaVentas();
    ...
    <div class="box-footer no-padding">
		...
		<ul class="nav nav-pills nav-stacked">
			 ...
			 <?php
              ...
              {
                  echo '<img src="View/img/productos/default/anonymous.png" class="img-thumbnail" width="60px" style="margin-right:10px">';    
