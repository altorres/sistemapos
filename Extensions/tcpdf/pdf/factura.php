...
$respuestaVenta = ControllerVentas::ctrMostrarVentas($itemVenta, $valorVenta);
...
$respuestaCliente = ControllerCliente::ctrMostrarClientes($itemCliente, $valorCliente);
...
$respuestaVendedor = ControllerUsuario::ctrMostrarUsuarios($itemVendedor, $valorVendedor);
...
$respuestaProducto = ControllerProductos::ctrMostrarProductos($itemProducto, $valorProducto, $orden);
